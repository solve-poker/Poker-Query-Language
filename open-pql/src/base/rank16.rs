...
mod tests {
    ...
    fn test_min_max_rank(cards: CardN<3>) {
        ...
        for c in cards {
            ...
            assert_eq!(c.rank, r.min_rank().unwrap());
            assert_eq!(c.rank, r.max_rank().unwrap());
        }
    ...
    #[test]
    fn test_u16_to_rank_str() {
        assert_eq!(u16_to_rank_str(0), "");
        assert_eq!(u16_to_rank_str(1), "2");
        assert_eq!(u16_to_rank_str(0b1), "2");
        assert_eq!(u16_to_rank_str(0b10), "3");
        assert_eq!(u16_to_rank_str(0b11), "23");
        assert_eq!(u16_to_rank_str(0b1_0000_0000_0000), "A");
        assert_eq!(u16_to_rank_str(0b1_0000_0000_0001), "2A");
        assert_eq!(u16_to_rank_str(0b1_1111_1111_1111), "23456789TJQKA");
    }
