use super::{
    ...
    STRAIGHT_9TJQK, STRAIGHT_89TJQ, STRAIGHT_789TJ, STRAIGHT_6789T,
    STRAIGHT_23456, STRAIGHT_34567, STRAIGHT_45678, STRAIGHT_56789,
    STRAIGHT_A2345, STRAIGHT_TJQKA, TRIPS, TWOPAIR, U16_5, flush_ranks,
    get_card_count, mk_masks_comb2rank, mk_masks_rank, mk_masks_rank13,
    mk_masks_rankcomb2, mk_masks_rankcomb3, mk_masks_rankrank, mk_ranking,
    retain_leading_2_bits, retain_leading_5_bits, retain_leading_bit,
    to_straightflush,
};
