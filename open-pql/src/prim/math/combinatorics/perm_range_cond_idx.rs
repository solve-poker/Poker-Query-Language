...
pub static PERM_BOARD_5: LazyLock<Vec<Vec<u8>>> = LazyLock::new(|| {
    vec![
        vec![0, 1, 2, 3, 4],
        vec![0, 2, 1, 3, 4],
        vec![1, 0, 2, 3, 4],
