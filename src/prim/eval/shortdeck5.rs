use super::{
    ...
    mk_masks_rankrank, mk_ranking, to_straightflush, FLUSH_SHORT,
    FULLHOUSE_SHORT, HIGHCARD, NONE_I16, STRAIGHT, STRAIGHT_789TJ,
    STRAIGHT_89TJQ, STRAIGHT_9TJQK, STRAIGHT_A789T, STRAIGHT_TJQKA, U16_T,
};
