use super::{
    common::NONE_I16, get_card_count, mk_masks_comb2rank, mk_masks_rank,
    mk_masks_rank13, mk_masks_rankcomb2, mk_masks_rankcomb3, mk_masks_rankrank,
    mk_ranking, retain_leading_2_bits, retain_leading_3_bits,
    retain_leading_bit, to_straightflush, FLUSH, FULLHOUSE, HIGHCARD, PAIR,
    QUADS, STRAIGHT, STRAIGHT_23456, STRAIGHT_34567, STRAIGHT_45678,
